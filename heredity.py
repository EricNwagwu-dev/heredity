...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if person in one_gene:
            if people[person]["mother"] in people and people[person]["father"] in people:
                if people[person]["mother"] in one_gene:
                    motherGave = .5 
                    motherDidnt = .5 
                elif people[person]["mother"] in two_genes:
                    motherGave = 1 - PROBS["mutation"]
                    motherDidnt = PROBS["mutation"]
                else:
                    motherGave = PROBS["mutation"]
                    motherDidnt = 1 - PROBS["mutation"]
                
                if people[person]["father"] in one_gene:
                    fatherGave = .5 
                    fatherDidnt = .5 
                elif people[person]["father"] in two_genes:
                    fatherGave = 1 - PROBS["mutation"]
                    fatherDidnt = PROBS["mutation"]
                else:
                    fatherGave = PROBS["mutation"]
                    fatherDidnt = 1 - PROBS["mutation"]
                probGene = fatherGave*motherDidnt + fatherDidnt*motherGave
            else:
            ...
            if people[person]["mother"] in people and people[person]["father"] in people:
                ...
                if people[person]["father"] in one_gene:
                    ...
                    fatherGave = PROBS["mutation"]
                probGene = fatherGave*motherGave
            else:
            ...
            if people[person]["mother"] in people and people[person]["father"] in people:
                ...
                if people[person]["father"] in one_gene:
                    ...
                    fatherDidnt = 1 - PROBS["mutation"]
                probGene = motherDidnt * fatherDidnt
            else:
